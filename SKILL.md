...
| `doctor` | hygiene scan (dirty/stale worktrees, task_id-authored commits made directly on `main` — first-parent view, so merge-integrated feature commits stay clean); always exits 0 |
