...
| `doctor` | anyone (main, hooks) | hygiene scan: dirty worktrees / stale worktrees / task_id-authored commits made directly on main (first-parent view — merge-integrated feature commits are not flagged); always exits 0 (feeds session-init Health) |
